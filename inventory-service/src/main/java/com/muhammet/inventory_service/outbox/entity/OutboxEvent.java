package com.muhammet.inventory_service.outbox.entity;
...
public class OutboxEvent {
    ...
    /*
     * RabbitMQ'ya gönderilecek event'in kendi kimliği.
     *
     * StockIncreaseCompletedEvent.eventId veya
     * StockIncreaseFailedEvent.eventId ile aynı olacak.
     */
    @Column(
            name = "event_id",
            nullable = false,
    ...
    /*
     * Inventory domain'indeki ilgili aggregate.
     *
     * Biz inventory sonuç eventlerinde:
    ...
    /*
     * Worker'ın bu kaydı yeniden deneyebileceği
     * en erken zaman.
     */
    @Column(
            name = "available_at",
