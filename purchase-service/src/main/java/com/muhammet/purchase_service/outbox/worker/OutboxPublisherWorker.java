package com.muhammet.purchase_service.outbox.worker;
...
import com.muhammet.purchase_service.outbox.service.OutboxEventProcessor;
    ...
    public void publishPendingEvents() {
        ...
        for (UUID eventId : eventIds) {
            try {
                ...
                /*
                 * Bir kayıttaki beklenmeyen DB hatası,
                 * diğer kayıtların işlenmesini engellemesin.
                 */
                log.error(
                        "Unexpected outbox processing failure. " +
                                "outboxId={}",
                        eventId,
                        exception
                );
